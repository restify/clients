...
function RequestCaptureStream(opts) {
    ...
    assert.optionalFinite(opts.level, 'options.level');
    assert.optionalFinite(opts.maxRecords, 'options.maxRecords');
    assert.optionalFinite(opts.maxRequestIds, 'options.maxRequestIds');
