...
function cloneRetryOptions(options, defaults) {
    ...
    var r = options || {};
    assert.optionalFinite(r.minTimeout, 'options.retry.minTimeout');
    assert.optionalFinite(r.maxTimeout, 'options.retry.maxTimeout');
    assert.optionalFinite(r.retries, 'options.retry.retries');
...
function HttpClient(options) {
    ...
    assert.optionalFinite(options.maxRedirects, 'options.maxRedirects');
